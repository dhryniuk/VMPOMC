...
function gradient(method, A::Array{<:Complex{<:AbstractFloat}}, l1::Matrix{<:Complex{<:AbstractFloat}}, params::parameters; 
    parallel=false, β::Float64=1.0, l2::Matrix{<:Complex{<:AbstractFloat}}=zeros(ComplexF64,1,1), basis=nothing, N_MC::Int64=0, ϵ::Float64=0.0)
    ...
    elseif method=="SR"
        if l2==zeros(ComplexF64,1,1)
            ...
            if parallel==false
                ...
                return distributed_SR_MPO_gradient_two_body(A, l1, N_MC, ϵ, params)
            end
        end
    else
